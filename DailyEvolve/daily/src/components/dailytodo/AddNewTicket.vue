<template>
    <Modal
      ...
      @on-visible-change="cancel">
        <Form ref="formRef" :model="formItem" :label-width="80" @submit.native.prevent="submit">
...
<script>
  ...
  export default {
    ...
    mounted: function () {
      this.volatitleProps = Object.getOwnPropertyNames(this.formItem)
    },
    methods: {
      handleSubmit (name) {
        console.log(name)
